...
nonisolated enum AppKitThemeAdapter {
    ...
    static let chromeSelection = dynamic(light: 0xF7F3EE, dark: 0x4D4742)
    static let chromeSelectionInk = dynamic(light: 0x2B2724, dark: 0xF2EFEA)
    ...
    static let workspaceRailTop = dynamic(light: 0xEEEBE4, dark: 0xEEEBE4)
    static let workspaceRailBottom = dynamic(light: 0xEEEBE4, dark: 0xEEEBE4)
    static let workspaceRailSolid = dynamic(light: 0xEEEBE4, dark: 0xEEEBE4)
    static let workspaceRailForeground = dynamic(light: 0x302E2B, dark: 0x302E2B)
    static let workspaceRailSecondary = dynamic(light: 0x68645F, dark: 0x68645F)
    static let workspaceRailSelection = dynamic(light: 0xDED1C6, dark: 0xDED1C6)
    static let workspaceRailHover = dynamic(light: 0xD8D4CD, dark: 0xD8D4CD)
    static let workspaceRailPressed = dynamic(light: 0xCCC7BF, dark: 0xCCC7BF)
    static let workspaceRailBorder = dynamic(light: 0xBFBAB2, dark: 0xBFBAB2)
