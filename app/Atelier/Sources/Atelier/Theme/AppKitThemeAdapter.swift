...
nonisolated enum AppKitThemeAdapter {
    ...
    static let sidebar = dynamic(light: 0xEEEBE3, dark: 0x202328)
    ...
    static let workflowDone = dynamic(light: 0x4E6C55, dark: 0x7FA98A)
    static let workflowTodo = dynamic(light: 0x8A652B, dark: 0xCAA15B)
    static let workflowBlocked = dynamic(light: 0x934941, dark: 0xD17B72)
    ...
    static let workspaceRailSelection = dynamic(light: 0x4C565F, dark: 0x46505A)
